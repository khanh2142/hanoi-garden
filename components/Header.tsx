      ...
      <div className="flex items-center justify-between border-gray-100 py-6 md:justify-start md:space-x-10">
        <div className="flex justify-start lg:w-0 lg:flex-1">
          <a href="/" className="flex align-middle gap-2">
            ...
            ></Image>
            <div className="h-100 flex items-center">Ha Noi Garden</div>
          </a>
        </div>
        ...
        <nav className="hidden space-x-1 md:flex">
          <a
            href="#"
            className="p-2 rounded text-base font-medium text-gray-500 ease-linear duration-300 hover:bg-green-400 hover:text-white"
          >
            Trang chủ
          </a>
          <a
        ...
        <div className="overflow-hidden items-center justify-end md:flex md:flex-1 lg:w-0 relative rounded-full">
          <div className="bg-green-100 rounded-full w-12 h-12 flex items-center justify-center cursor-pointer cart__container overflow-hidden z-20">
            <Image
              src={cart}
              alt="Giỏ hàng"
              width={36}
