...
const ProductCard = ({
  ...
  return (
    <div
      className={`w-full flex flex-col gap-4 py-1 rounded-md hover:shadow-2xl ease-linear duration-300 justify-center items-center group relative hover:shadow-${color} z-10`}
      tabIndex={tabIndex}
    >
